...
const defaultFieldsDensity = { "t": 1, "numU": 128, "numOde": 128, "a": 0.3, "sigma": 0.3, "lambda": 100, "correlation": 0.8, "alpha": 1.1, "mu": 1300, "c": 100 }
const Density = ({ onSubmit, isLoading }) => {
    ...
    return (
        <Form onSubmit={onSubmit(fields, numFields => getData(numFields, 'https://e43exqgwxl.execute-api.us-east-1.amazonaws.com/prd/v1/ops/density'))}>
