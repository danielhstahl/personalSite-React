...
const defaultFieldsDensity = { "lambda": 0.5, "q": 0.05, "numU": 128, "pd": 0.02, "numLoans": 100000, "volatility": 0.5 }
const Density = ({ onSubmit, isLoading }) => {
    ...
    return (
        <Form onSubmit={onSubmit(fields, numFields => getData(numFields, 'https://5qsvissse9.execute-api.us-east-1.amazonaws.com/prd/v1/credit/density'))}>
